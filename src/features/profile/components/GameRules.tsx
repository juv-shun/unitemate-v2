...
const rules: Rule[] = [
	{
		icon: "🏆",
		text: "大会モード テイア蒼空遺跡(カイオーガ)ドラフトピック（メダルなし）",
		delay: 0,
	},
	{
		icon: "🚫",
...
export function GameRules() {
	...
	return (
		...
		>
			...
			{/* Section header with angular cut */}
			<div className="relative mb-6">
				...
				>
					<h2
						className="text-sm font-bold tracking-[0.2em] uppercase relative z-10"
						style={{
