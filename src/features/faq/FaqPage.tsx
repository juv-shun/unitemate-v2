...
const faqItems: FaqItem[] = [
  ...
  },
  {
    question:
      "マッチングアルゴリズムを教えて下さい。",
    answer:
      "1分に1回定期バッチが動いており、起動されたタイミングでキューに30人以上、もしくは1分以上待機しているユーザーがいれば、マッチングが行われます。マッチングは、レートが高い順に10人ずつ抽出されてチームが組まれます。",
    delay: 0.2,
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "現状では、禁止しても、違反したことによるペナルティ付与する運用コストをかけられないことから、禁止しない方向にしています。",
    delay: 0.5,
  },
];
